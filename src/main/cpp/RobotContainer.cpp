...
frc2::JoystickButton m_controllerButton8{&m_controller, (int)frc::XboxController::Button::kStart}; // Compressor Disable (8)
...
m_controllerButton7.OnTrue(CompressorEnableCommand(&m_grabber).ToPtr()); // Compressor Enable (7)
m_controllerButton8.OnTrue(CompressorDisableCommand(&m_grabber).ToPtr());  // Compressor Disable (8)
